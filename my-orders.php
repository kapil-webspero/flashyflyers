        ...
        <div class="container">
            ...
            <section class="orders-top mb-4">
                    <div class="row">
                        ...
                        <?php /*?><div class="col-lg-3 col-sm-6 mb-4 cursor_pointer  cursor_pointer <?php echo($_REQUEST['mode']=="") ?"active_box":"" ?>"  onClick="window.location='my-orders.php'">
                        ...
                        <div class="col-lg-3 col-sm-6 mb-4 cursor_pointer  cursor_pointer <?php echo($_REQUEST['mode']=="proccess") ?"active_box":"" ?>"  onClick="window.location='my-orders.php?mode_type=top_filter&mode=proccess'">
							...
							$inProgressStatsquery = "SELECT COUNT(DISTINCT TransactionID) as num FROM ".$searchTable." where  is_approve != '1' AND ResponseState !='2' AND ResponseState IN('0','3','4') and OrderStatus IN('1','2','3') and CustomerID='".$AccessID."'";
							
							$inProgressStats = mysql_fetch_array(mysql_query($inProgressStatsquery));
									
								echo $inProgressStats['num'];		
								?></h1>
                                <p>in progress </p>
                        ...
                        <div class="col-lg-3 col-sm-6 mb-4 cursor_pointer  cursor_pointer <?php echo($_REQUEST['mode']=="pending_payment") ?"active_box":"" ?>"  onClick="window.location='my-orders.php?mode_type=top_filter&mode=pending_payment'">
                            <div class="totals-box purple">
                                <h1><?php 
								
									$Revisionquery = "SELECT COUNT(DISTINCT TransactionID) as num FROM ".$searchTable." where  AssignedTo = 0  and OrderStatus='4'  AND is_approve!= '1' and CustomerID='".$AccessID."'";
								
								$RevisionqueryData = mysql_fetch_array(mysql_query($Revisionquery));
								echo $RevisionqueryData['num'];?></h1>
                                <p>pending payment</p>
                        ...
                        <div class="col-lg-3 col-sm-6 mb-4 cursor_pointer <?php echo($_REQUEST['mode']=="rivision") ?"active_box":"" ?>"  onClick="window.location='my-orders.php?mode_type=top_filter&mode=rivision'">
                            <div class="totals-box blue">
                                <h1><?php 
									...
									$Revisionquery = "SELECT COUNT(DISTINCT TransactionID) as num FROM ".$searchTable." where  AssignedTo > 0  and OrderStatus='1' and ResponseState='2' AND is_approve!= '1' and CustomerID='".$AccessID."'";
									$RevisionqueryData = mysql_fetch_array(mysql_query($Revisionquery));
                        ...
                        <div class="col-lg-3 col-sm-6 mb-4 cursor_pointer <?php echo($_REQUEST['mode']=="finish") ?"active_box":"" ?>"  onClick="window.location='my-orders.php?mode_type=top_filter&mode=finish'">
                            <div class="totals-box green" style="color:green;">
                                <h1><?php 
							$completedFinishOrderDataQuery = "SELECT COUNT(DISTINCT TransactionID) as num FROM ".ORDER." WHERE CustomerID='".$AccessID."' and ((is_approve = '1') OR (ResponseState IN('1') AND OrderStatus IN('1')))";
							$completedFinishOrderData = mysql_fetch_array(mysql_query($completedFinishOrderDataQuery));
							
							 	echo $completedFinishOrderData['num'];
	...
	?>                   
                                <tr>
                                	    	<td class="data-view mobileVersionViewAction"><a style="margin:0 auto;width:80px;padding:5px; background:#0070c0; margin-bottom:5px;"    href="<?=SITEURL;?>my-orders.php?orderUID=<?=$showData['TransactionID'];?>" class="view" title="View">View</a>
                                               <?php if($TransactionData['RepUserID']>0 && ($TransactionData['PaymentStatus']=="Sales pending payment") || ($TransactionData['PaymentStatus']=="Pending payment") ){ ?> 
