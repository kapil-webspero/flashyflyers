                                        ...
                                        <label class="custom-control custom-checkbox" style="margin-top:15px;margin-left:5px;">
                                          ...
                                          <span class="custom-control-description">
                                            ...
                                            <div class="buy-btns mt-4">
                                                ...
                                                <a class="buy-btn addon_buy" data-order-type="template"><span class="price" id="totalCartAmount">$<?php if(!empty($preSelection['totalPrice']) && $preSelection['template_type']!="psd") { echo formatPrice($preSelection['totalPrice']); } else { echo formatPrice($product['Baseprice']); }?></span> <span class="buy-label"><i class="fas fa-shopping-cart"></i> Proceed</span></a>
                                           <?php /*?><div class="ProoccedBtn"><input type="button" value="Proceed"></div><?php */?>
