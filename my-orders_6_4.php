...
if($total_pages>0) {
	...
	?>                   
                                <tr>
                                	    	<td class="data-view mobileVersionViewAction"><a style="margin:0 auto;width:80px;padding:5px;"    href="<?=SITEURL;?>my-orders.php?orderUID=<?=$showData['TransactionID'];?>" class="view">view</a></td>
							...
							if($AssignTo==0 && $OrderStatus==4 ) {
								...
								echo "In progress";
									...
									?></td>
                                   	<td class="data-view DesktopVersionViewAction"><a style="background: #0070c0;padding: 5px 18px;color: #fff;border-radius: 10px;text-decoration: none; display:block; margin-bottom:5px;display:block;"    href="<?=SITEURL;?>my-orders.php?orderUID=<?=$showData['TransactionID'];?>" class="view">view</a>
                                    
                                    <?php if($TransactionData['RepUserID']>0 && $TransactionData['PaymentStatus']=="Sales pending payment"){ ?> 
                                    <a class="finish-btn" style="background: #3bc178 ;padding: 5px 18px;color: #fff; display:block;border-radius: 10px;text-decoration: none;" href="<?php echo SITEURL; ?>checkout.php?key=<?=$TransactionData['RepKey'];?>">Pay Now</a>
                                    <?php } ?>
