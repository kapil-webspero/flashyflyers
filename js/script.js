...
jQuery(document).ready(function(e) {
var defaultSize = jQuery("input[name='defaultSize']:checked").val();
jQuery(".defaultImagesSizeData").hide();
jQuery(".defaultImagesSizeData"+defaultSize).show();	

jQuery(document).on("change",".defaultSize",function(){
jQuery(".defaultImagesSizeData").hide();
jQuery(".defaultImagesSizeData"+jQuery(this).val()).show();	
});
