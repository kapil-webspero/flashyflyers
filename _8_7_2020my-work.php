...
$prodsArr = getALLProductArr();	
   ...
   if(isset($_REQUEST['product_type']) && !empty($_REQUEST['product_type']) && $_REQUEST['product_type'] != "all") {
    ...
    $newOrder = (!empty($Newordertotal_pages['num'])) ?  $Newordertotal_pages['num'] : '0';
                        ...
                        <div class="col-lg-3 col-sm-6 mb-4  cursor_pointer <?php echo($_REQUEST['mode'] =="" || $_REQUEST['mode']=="proccess") ?"active_box":"" ?>"  onClick="window.location='my-work.php?mode_type=top_filter&mode=proccess'">
                            <div class="totals-box cyan">
                                <h1><?php 
								$inProgressStatsquery = "SELECT COUNT(DISTINCT TransactionID) as num FROM ".$searchTable." where `AssignedTo` = '".$AccessID."' and  is_approve != '1'";
                        ...
                        <div class="col-lg-3 col-sm-6 mb-4 cursor_pointer <?php echo($_REQUEST['mode']=="year") ?"active_box":"" ?>"  onClick="window.location='my-work.php?mode_type=top_filter&mode=year'">
                        ...
                        <div class="col-lg-3 col-sm-6 mb-4 cursor_pointer <?php echo($_REQUEST['mode']=="finish") ?"active_box":"" ?>"  onClick="window.location='my-work.php?mode_type=top_filter&mode=finish'">
                            <div class="totals-box" style="color:green;">
                                <h1><?php  
									$completedFinishOrderDataQuery = "SELECT COUNT(DISTINCT TransactionID) as num FROM ".ORDER." WHERE `AssignedTo` = '".$AccessID."' and is_approve = '1'";
	
	$completedFinishOrderData = mysql_fetch_array(mysql_query($completedFinishOrderDataQuery));
	
								
							echo $completedFinishOrderData['num'];?></h1>
                                <p style="color:green;">completed order</p>
