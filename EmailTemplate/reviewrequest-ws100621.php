...
if ( ! empty( $_REQUEST['UID'] ) && $_REQUEST['orderids'] ) {
    ...
    foreach ($orderIdArray as $orderId) {
        ...
        $OrderUserData = GetSglRcrdOnCndi( ORDER, "id=" . $orderId );
        $orderDetailURL = SITEURL . 'order-details.php?order_id=' . $OrderUserData['TransactionID'];
        $productData = GetSglRcrdOnCndi( PRODUCT, "id=" . $OrderUserData['ProductID'] );
        ...
        $mail = <<<EOF
            ...
            <td>
                 ...
                 <tr>  <td><img src="$imgtop"></td> </tr>
                  ...
                  <td style="font-size:30px; color:#d33b30; font-weight:bold; font-family:Arial; text-align:center;  line-height:20px;"> Review request </td>
                ...
                <tr>
                 ...
                 <td style=" font-size:14px; font-family:Arial; text-align:left; line-height:20px;">Hello <strong>
                  ...
                  <td style=" font-size:14px; font-family:Arial; text-align:left; line-height:20px;">
                   ...
                   Thanks for using Service Lane.
                   This message has been sent to you on behalf of <strong>$productName</strong> who recently did some work for
                   you via Service Lane.<br><br>

                   Could you pllease take a minute to post a review about $productName services:
                   <br>
                   <br>
                   <center><a href="$orderDetailURL">Click here to post a review</a></center>
