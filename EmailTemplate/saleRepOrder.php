...
$email1->setFrom($from);
$email1->setSubject('Customer Order Created');
$email1->addTo($salesEmail);
$email1->addContent("text/html", $mail2);
...
try {
		...
		// print $response->body() . "\n";
		echo "Your mail has been sent successfully to $salesEmail.";
} catch (Exception $e) {
