...
$resetlink=SITEURL.'resetpassword.php?reset='.$_REQUEST['reset'];
$mail = <<<EOF
...
<tr>
    <td>
         ...
         <tr>  <td><img src="$imgtop"></td> </tr>
          ...
          <td style="font-size:30px; color:#d33b30; font-weight:bold; font-family:Arial; text-align:center;  line-height:20px;"> Password Reset  </td>
	...
	<table width="95%" cellpadding="0" cellspacing="0" border="0" align="center" height="15">
        ...
        <tr>
         ...
         <td style=" font-size:14px; text-align:left; line-height:20px;">

          <font face="Arial"  color="#000000" style="font-size:14px; line-height:20px; text-align:left;">Hello <strong>$FName $LName,</strong><br/><br/></font></td>
		  ...
		  <b><a href="$resetlink"> Please click on this link to reset your password </a></b> <br>





		  <br>If you have any questions or comments, please feel free to give us a shout at contact us at support@flashyflyers.com - our support team will respond to your inquiry promptly.</td>
...
EOF;
$to = $Email;
$subject = 'Password Recovery - Flashy Flyers';
