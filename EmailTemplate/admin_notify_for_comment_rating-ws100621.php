...
if ( ! empty( $_REQUEST['order_id'] ) ) {
    ...
    $orderData = GetSglRcrdOnCndi( ORDER, "id=" . $orderId );
    ...
    $adminData = GetMltRcrdsOnCndi( USERS, "UserType='admin'" );
    
    foreach ($adminData as $keyAdmin => $adminValue) {
        $adminUserName = $adminValue['FName'] . ' ' . $adminValue['LName'];
        ...
        $mail = <<<EOF
            ...
            <td>
                 ...
                 <tr>  <td><img src="$imgtop"></td> </tr>
                  ...
                  <td style="font-size:30px; color:#d33b30; font-weight:bold; font-family:Arial; text-align:center;  line-height:20px;"> New added comment and rating </td> 
            ...
            <table width="95%" cellpadding="0" cellspacing="0" border="0" align="center" height="15">
                ...
                <tr> 
                 ...
                 <td style=" font-size:14px; font-family:Arial; text-align:left; line-height:20px;">Hello <strong>$adminUserName,</strong><br/><br/></td>
                  ...
                  <td style=" font-size:14px; font-family:Arial; text-align:left; line-height:20px;">
                   ...
                   <strong>$productName</strong> in recently added new comment and rating.
                   <br>
                   <br>
                   <center><a href="$adminOrderDetailURL">click here to view comment and review</a></center>
...
EOF;
        ...
        $to = $Email;
        $subject = 'New added comment and rating to flashyflyers';
