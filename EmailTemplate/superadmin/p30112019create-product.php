    ...
    <div class="container">
        <div class="main-content pl-60 pr-60 bx-shadow">
            ...
            <div class="row">
                ...
                <div class="row CustomProductFiledsSetting" <?php if($_REQUEST['Addon'] == 1) { echo 'style="display:none;"'; } ?>>
                    	<div class="col-md-12">
                            <label>Is this an custom product?</label>
                            <br>
                            <label class="custom-control custom-radio" style="margin-bottom: 40px;">
                                <input type="radio" class="custom-control-input" value="yes" name="CustomProduct" <?php if($_REQUEST['CustomProduct'] == "yes") { echo "checked"; } ?>>
                                <span class="custom-control-indicator"></span>
                                <span class="custom-control-description">Yes</span>
                            </label>
                            <label class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" value="no" name="CustomProduct" <?php if($_REQUEST['CustomProduct'] == "no") { echo "checked"; } ?>>
                                <span class="custom-control-indicator"></span>
                                <span class="custom-control-description">No</span>
                            </label>
                            
                            <div class="CustomProductFileds" <?php if($_REQUEST['CustomProduct'] == "yes") { echo 'style="display:block;"'; } ?>>
                            ...
                            <li>
                            <label class="custom-control custom-checkbox">
                                <input type="checkbox" name="CustomeProductfieldsSettings[<?php echo $single['id']; ?>]"  class="custom-control-input" value="1">
                                <span class="custom-control-indicator"></span>
                ...
                <div class="row show_flyer_section">
                    <div class="col-md-6">
                ...
                <?php if(!empty($addonProductList) && count($addonProductList) > 0){ ?>
                    <div class="row" id="product_addon" style="display:none;">
                        <div class="col-md-6">
                            <label>Addons: </label>
                            <br>
