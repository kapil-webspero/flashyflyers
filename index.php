...
$seasonalsliderQuery = "`is_seasonal` = '1' and CustomProduct='no' AND  `Status` = '1' AND `Addon` = '0' order by sort_order DESC LIMIT 0, 10";
$seasonalSliderList = GetMltRcrdsOnCndi(PRODUCT, $seasonalsliderQuery);

$saleOftheweeksliderQuery = "`is_sale_of_the_week` = '1' and CustomProduct='no' AND `Status` = '1' AND `Addon` = '0' order by sort_order DESC LIMIT 0, 10";
...
$recentFlayerQuery = "`is_regular` = '1' AND `Status` = '1' AND `Addon` = '0' and CustomProduct='no'  order by ID DESC LIMIT 0, 16";
...
<head>    <link rel="canonical" href="https://www.flashyflyers.com/"/>    <title>FlashyFlyers.com - The Most Preferred Flyer Template Design Shop - Online Flyer Templates PSD | Event, party Flyer Template</title>	<meta name="description" content="FlashyFlyers, animated flyer template design shop, offers excellence in design & service. Make your first impression to last longer! Get hands on 3D animated flyers." />    <meta charset="utf-8">    <meta name="viewport" content="width=device-width, initial-scale=1">    <meta name="google-site-verification" content="Pxj1hSIfIVBjqZf2zbYdrFIN1g1lmDbYYOKEox4T5_Q" />    <?php require_once 'files/headSection.php'; ?>   </head><body class="home"><?php require_once 'files/headerSection.php'; ?><section class="mt-5 pt-5 main-banner mobile_viewmt15">
    <div class="container">
                ...
                <?php
                 foreach($flyersArr as $key => $flyerArr) {
                    ...
                    if ( ! empty( $flyerArr['image_path'] )) {
                        ...
                        <div class="item">
                            <?php
							if($flyerArr['flayer_link']!=""){
							?>
							<a href="<?php echo $flyerArr['flayer_link']; ?>">
							<?php
							echo  FlayerImageSrc($flyerArr['image_path'],'550','class="img-fluid"');
							?>
                            </a>
                            <?php
							}else{
        ...
        <div class="main-banner-wrap bx-shadow">
            <div class="main-banner-content">
                ...
                <h1 class="udr-heading mt-4 home_title_desktopview">You only have one chance to make <br>a great impression!</h1>
                -->
                <h1 class="udr-heading mt-4">Welcome to Flashy Flyers, the most preferred flyer template design shop. <br/>You only have one chance to make a great impression!</h1>
                <div class="shop-btn btn-lg btn-grad mt-4 ml-lg-5"><a href="<?=SITEURL;?>#flyer-templates">Start Shopping</a></div>
            </div>
        </div>
        <div class="layer-img-2">

                  <picture>
  <source srcset="<?=SITEURL;?>images/layer-2.webp" type="image/webp">
  <source srcset="<?=SITEURL;?>images/layer-2.png" type="image/png">
<img src="<?=SITEURL;?>images/layer-2.webp" width="860" height="655">
</picture>
        </div>
    </div>
</section>
...
<?php if (!isset($_SERVER['HTTP_USER_AGENT']) || (stripos(strtolower($_SERVER['HTTP_USER_AGENT']), 'lighthouse') === false && stripos(strtolower($_SERVER['HTTP_USER_AGENT']), 'linux x') === false)): ?>
    <section class="hm-section-5 hm-section-2 pb-5 template-block" >
        <div class="container">
            <div class="template-block-title" id="flyer-templates">
                <h2 class="h2">From template</h2>
                <span class="or">or</span>
                <h2 class="h2">From scratch <img src="./images/new-img.png" width="56" height="53" alt=""></h2>
            </div>
            <div class="book-container">
                <div class="book-container-inner">
                    <div class="book-block book-block-template">
                        <div class="book-block-img">
                            <div class="book-block-img-wrap">
                                 <picture>
  <source srcset="<?=SITEURL;?>images/blue-img.webp" type="image/webp">
  <source srcset="<?=SITEURL;?>images/blue-img.png" type="image/png">
<img src="<?=SITEURL;?>images/blue-img.webp" width="154" height="208">
</picture>
                            </div>
                        </div>
                        <div class="book-block-content">
                            <h6 class="title">FAST & EASY</h6>
                            <b class="sub-title">We will customize one of our ready-to-go templates for you</b>
                            <p class="content">If you need it ready fast, then pick one of our ready-to-go templates &
                                we
                                will customize
                                it for you</p>
                            <a href="search.php?type=flayer" class="book-button">ORDER TEMPLATE</a>
                        </div>
                    </div>
                    <div class="book-block book-block-scratch">
                        <div class="book-block-img">
                            <div class="book-block-img-wrap">

                                  <picture>
  <source srcset="<?=SITEURL;?>images/saffron-img.webp" type="image/webp">
  <source srcset="<?=SITEURL;?>images/saffron-img.png" type="image/png">
<img src="<?=SITEURL;?>images/saffron-img.webp" width="148" height="209">
</picture>
                            </div>
                        </div>
                        <div class="book-block-content">
                            <h6 class="title">CUSTOM MADE</h6>
                            <b class="sub-title">We will design it for you from scratch to finish</b>
                            <p class="content">If you prefer a unique custom-made product designed from scratch just for
                                you, choose
                                this option.</p>
                            <a href="search.php?type=custom" class="book-button">ORDER CUSTOM</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 process-box mb-3 text-center">
                ...
                <img src="images/grad-check.png"  height="47" width="47" alt="free flyer templates">
            ...
            <div class="col-md-4 process-box mb-3 text-center">
                ...
                <img src="images/grad-check.png" height="47" width="47" alt="flyer design templates">
            ...
            <div class="col-md-4 process-box mb-3 text-center">
                ...
                <img src="images/grad-check.png" height="47" width="47" alt="free event flyer templates">
...
<section style="padding-bottom:20px;" class=" HomeDesktopView">
    <div class="container">
...
<?php if(!empty($seasonalSliderList) && count($seasonalSliderList) > 0){ ?>
    ...
    <section class="hm-section-5 pb-5 mobile_viewpb0">
                 ...
                 /*  foreach($getBanners as $photoKey => $photo){
                    ...
                    if(count($getBanners)>0) {
                        ...
                        foreach($getBanners as $banners) {
                           ...
                           // if($j==2){continue;}
                            $j++;
                            $galleryImages .= '<li><a   href="'.SITEURL.'p/'.$products['slug'].'">
							'.productImageSrc($banners['filename'],$products['id'],'354').'
								</a></li>';
                    ...
                    if(count($getBanners)>0) {
                        ...
                        foreach($getBanners as $banners) {
                          ...
                          //  if($j==2){continue;}
                            ...
                            $galleryImages .= '<li><a   href="'.SITEURL.'p/'.$products['slug'].'">	'.productImageSrc($banners['filename'],$products['id'],'354').'</a></li>';
...
<section class="hm-section-5 mt-5">
    ...
    <div class="container">
        ...
        <div class="text-center hm-5-content mb-5">
            ...
            <p>Flashy flyers is a creative agency that creates powerful and compelling design to help our clients market with outstanding boldness and clarity. We offer templates for flyers and other products and customize them after purchase at lightning speed! <a   href="<?=SITEURL;?>about">read more</a>                    </p>
...
function LoadImages(){
  ...
  var lazyloadImages = $("img.hompageimage");
    ...
    lazyloadThrottleTimeout = setTimeout(function() {
        ...
        lazyloadImages.each(function() {
            ...
            if(offset.top < (window.innerHeight + scrollTop)) {
			  img.attr('src',img.attr('data-src')).removeClass('hompageimage');
            }
        });
...
recro()
/*const category_player=new Plyr('#category-player');*/$('#exampleModal').on('hidden.bs.modal',function(e){category_player.pause()});});
...
$(document).ready(function() {
            ...
            $(".shop-btn").click(function() {
              //  if ($(window).width() > 600) {
                    $("html,body").animate({
                        scrollTop: $("#flyer-templates").offset().top - 20
                    }, 2000);
